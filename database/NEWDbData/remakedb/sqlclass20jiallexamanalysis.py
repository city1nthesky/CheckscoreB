...
def adddb(dbname):
    ...
    #data = SG2LK_2022 + SG2WK_2022
    data = SG1WHS_2022 + SG1WHZ_2022 + SG1WHD_2022 + SG1SZD_2022 + SG1SZS_2022
    classname = ""
    for tmp in data:
        print(tmp)
        ...
        for row in cursor:
            ...
            sql = "insert into CurrentClassGradeAnalysis" + """(ClassGrade , Year, Exam,
                   Sum, Yuwen, Shuxue,Waiyu,
                   Select1,Select2,Select3
                   ) 
                   values(""" + str(tmp) + ", '2023s', '" + str(row[0]) + "', "\
