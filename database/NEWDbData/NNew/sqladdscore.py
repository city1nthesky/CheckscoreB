...
def opendb(dbname, classname):
    ...
    sql = "create table if not exists SCORE "  + """ (
           NAME TEXT NOT NULL,STUID TEXT NOT NULL, GRADE TEXT NOT NULL,EXAM TEXT NOT NULL,
           SUM TEXT NOT NULL,SUMB TEXT NOT NULL, SUMD TEXT NOT NULL,
           YUWEN TEXT NOT NULL,YUWENB TEXT NOT NULL, YUWEND TEXT NOT NULL,
           SHUXUE TEXT NOT NULL,SHUXUEB TEXT NOT NULL, SHUXUED TEXT NOT NULL,
           YINGYU TEXT NOT NULL,YINGYUB TEXT NOT NULL, YINGYUD TEXT NOT NULL,
           SELECT1 TEXT NOT NULL,SELECT1B TEXT NOT NULL, SELECT1D TEXT NOT NULL,
           SELECT2 TEXT NOT NULL,SELECT2B TEXT NOT NULL, SELECT2D TEXT NOT NULL,
           SELECT3 TEXT NOT NULL,SELECT3B TEXT NOT NULL, SELECT3D TEXT NOT NULL,
           ZONGHE TEXT NOT NULL,ZONGHEB TEXT NOT NULL, ZONGHED TEXT NOT NULL
           )"""
...
def adddb(dbname):
    ...
    for tmp in data:
        ...
        c = conn.cursor()
        sql2 = "select * from s2021" + str(stuid)
        print(sql2)
        try:
            # 执行SQL语句
            cursor = c.execute(sql2)
